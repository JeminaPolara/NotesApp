...
package com.note.remindernote.views;

import static android.view.ViewGroup.LayoutParams.MATCH_PARENT;
import static androidx.core.view.ViewCompat.animate;
import static com.note.remindernote.utils.ConstantsBase.FAB_ANIMATION_TIME;
...
import com.note.remindernote.listeners.OnFabItemClickedListener;
...
public class Fab {
  ...
  public void setOverlay(int colorResurce) {
    View overlayView = new View(MyApp.getAppContext());
